...
namespace Scripts.Networking
{
    ...
    public class Packet : IDisposable
    {
        ...
        public void Write(SpawnTemplate _value)
        {
        ...
        /// <summary>Reads an Vector2Int from the packet.</summary>
        /// <param name="_moveReadPos">Whether or not to move the buffer's read position.</param>
        ...
        /// <param name="_moveReadPos">Whether or not to move the buffer's read position.</param>
        public SpawnTemplate ReadSpawnTemplate(bool _moveReadPos = true)
        {
            ...
            Vector2Int position = ReadVector2Int(_moveReadPos);

            return new SpawnTemplate(controllingPlayer, movePoints, health, orientation, position);
        }
